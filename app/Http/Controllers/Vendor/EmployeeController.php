...
class EmployeeController extends Controller
{
    ...
    public function list_export(Request $request){
        ...
        if ($request->type == 'excel') {
            return Excel::download(new RestaurantEmployeeListExport($data), 'Funcionários.xlsx');
        } else if ($request->type == 'csv') {
            return Excel::download(new RestaurantEmployeeListExport($data), 'Funcionários.csv');
        }
    }
}
