    ...
    public function export_account_transaction(Request $request){
        try{
                ...
                if ($request->type == 'excel') {
                    return Excel::download(new CollectCashTransactionExport($data), 'Colete transações em dinheiro.xlsx');
                } else if ($request->type == 'csv') {
                    return Excel::download(new CollectCashTransactionExport($data), 'Colete transações em dinheiro.csv');
                }
