    ...
    public function export(Request $request)
    {
        ...
        try{
            ...
            if ($request->type == 'excel') {
                return Excel::download(new CustomerLoyaltyTransactionExport($data), 'Transações de fidelidade do cliente.xlsx');
            } else if ($request->type == 'csv') {
                return Excel::download(new CustomerLoyaltyTransactionExport($data), 'Transações de fidelidade do cliente.csv');
            }
