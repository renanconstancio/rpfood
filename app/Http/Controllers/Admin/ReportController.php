...
//        dd($expense);
    ...
    public function restaurant_export(Request $request)
    {
        ...
        if ($request->export_type == 'csv') {
            return Excel::download(new RestaurantSummaryReportExport($data), 'Relatório do restaurante.csv');
        }
        return Excel::download(new RestaurantSummaryReportExport($data), 'Relatório do restaurante.xlsx');
