...
class AttributeController extends Controller
{
    ...
    public function bulk_export_data(Request $request)
    {
        ...
        ->get();
        return (new FastExcel($attributes))->download('Atributos.xlsx');
    }
    ...
    public function export_attributes($type){
        ...
        if($type == 'excel'){
            return (new FastExcel(Helpers::export_attributes($collection)))->download('Atributos.xlsx');
        }elseif($type == 'csv'){
            return (new FastExcel(Helpers::export_attributes($collection)))->download('Atributos.csv');
        }
    }
}
