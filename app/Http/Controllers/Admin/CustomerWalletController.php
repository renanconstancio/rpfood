    ...
    public function export(Request $request)
    {
        try{
                ...
                if ($request->type == 'excel') {
                    return Excel::download(new CustomerWalletTransactionExport($data), 'Transações da carteira do cliente.xlsx');
                } else if ($request->type == 'csv') {
                    return Excel::download(new CustomerWalletTransactionExport($data), 'Transações da carteira do cliente.csv');
                }
            }  catch(\Exception $e){
