...
//        }
    ...
    public function earning_export(Request $request){
        try{
            ...
            if ($request->type == 'excel') {
                return Excel::download(new DeliveryManEarningExport($data), 'Ganhos de entregadores.xlsx');
            } else if ($request->type == 'csv') {
                return Excel::download(new DeliveryManEarningExport($data), 'Ganhos de entregadores.csv');
            }
        }  catch(\Exception $e){
            Toastr::error("line___{$e->getLine()}",$e->getMessage());
            info(["line___{$e->getLine()}",$e->getMessage()]);
    ...
    public function reviews_export(Request $request){
        try{
            ...
            if ($request->type == 'excel') {
                return Excel::download(new DeliveryManReviewExport($data), 'Revisões de entregadores.xlsx');
            } else if ($request->type == 'csv') {
                return Excel::download(new DeliveryManReviewExport($data), 'Revisões de entregadores.csv');
            }
        }  catch(\Exception $e){
            Toastr::error("line___{$e->getLine()}",$e->getMessage());
            info(["line___{$e->getLine()}",$e->getMessage()]);
    ...
    public function review_export(Request $request){
        try{
            ...
            if ($request->type == 'excel') {
                return Excel::download(new SingleDeliveryManReviewExport($data), 'Revisões de entregadores.xlsx');
            } else if ($request->type == 'csv') {
                return Excel::download(new SingleDeliveryManReviewExport($data), 'Revisões de entregadores.csv');
            }
        }  catch(\Exception $e){
            Toastr::error("line___{$e->getLine()}",$e->getMessage());
            info(["line___{$e->getLine()}",$e->getMessage()]);
