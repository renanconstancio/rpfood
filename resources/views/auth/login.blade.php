@php $log_email_succ = session()->get('log_email_succ'); @endphp
<!DOCTYPE html>
...
<head>
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.login') }} | {{$app_name??translate('FASTDELIVERY')}}</title>
...
<main id="content" role="main" class="main auth-bg">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between">
        <div class="auth-content">
            <div class="content">
                <h2 class="title text-uppercase">{{translate('messages.welcome_to')}} {{ $app_name??'FASTDELIVERY' }}</h2>
                <p>
...
<!-- IE Support -->
<script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="{{asset('public//assets/admin')}}/vendor/babel-polyfill/polyfill.min.js"><\cript>');
</script>
</body>
</html>
