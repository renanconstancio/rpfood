                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                <p>
                                                    {{ translate('get_your_zip_file_from_the_purchased_theme_and_upload_it_and_activate_theme_with_your_Lojadev_username_and_purchase_code') }}.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" name="username" value=""
                                            class="form-control" placeholder="{{ translate('lojadev_username') }}">
                                </div>
                                <div class="form-group">
