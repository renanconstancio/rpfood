        ...
        <div class="card-header flex-wrap gap-2">
            ...
            <div>
                <button class="btn add-outline-btn" data-toggle="modal" data-target="#modal ">
                    ...
                    <span class="txt">Adicionar Página</span>
                    <span data-toggle="tooltip" title="Adicione nova página">
            ...
            <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table dataTable no-footer">
                ...
                <tbody>
                    <tr>
                        <td>01</td>
                        <td>
                            <span class="font-semibold text-title">Marcas</span>
                        </td>
                        <td>
                            <a href="" class="text-primary text-underline">https://lojadodesenvolvedor.com.br </a>
                        </td>
                        <td>    
                            <div class="text-center">
                                <a href="" class="btn btn--primary btn-outline-primary add-content-btn"><i class="tio-add"></i> <span>Adicionar conteúdo</span></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>02</td>
                        <td>
                            <span class="font-semibold text-title">Categoria</span>
                        </td>
                        <td>
                            <a href="" class="text-primary text-underline">https://lojadodesenvolvedor.com.br </a>
                        </td>
                        <td>    
                            <div class="text-center">
                                <a href="" class="btn btn--primary btn-outline-primary edit-content-btn"><i class="tio-add"></i> <span>Editar conteúdo</span></a>
                            </div>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <div>
                        <nav>
                            <ul class="pagination">
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="#" rel="next" aria-label="Próxima »">›</a>
                                </li>
                            </ul>
                        </nav>
