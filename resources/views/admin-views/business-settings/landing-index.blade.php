                            ...
                            <div class="__input-tab {{  $landing_integration_type == 'url'?'active':''  }}" id="url">
                                <div class="__bg-F8F9FC-card">
                                    <div class="form-group mb-0 pb-2">
                                        ...
                                        <input type="url" placeholder="{{ translate('messages.Ex: https://fastdelivery-admin.lojadodesenvolvedor.com.br/') }}" class="form-control h--45px" name="redirect_url" value="{{ $redirect_url }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="__input-tab {{ $landing_integration_type == 'none' ?'active':'' }}" id="none">
                                <div class="__bg-F8F9FC-card">
                                    ...
                                    <div class="text-center max-w-595 mx-auto py-4">
                                        ...
                                        <p class="m-0">
                                            {{ translate('Currently_you_are_using_Fastdelivery_Default_Admin_Landing_Page_Theme.') }}
